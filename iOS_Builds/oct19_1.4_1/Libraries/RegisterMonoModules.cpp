...
extern "C"
{
	...
	const char*			UnityIPhoneRuntimeVersion = "4.6.0b20";
	...
	extern gpointer*	mono_aot_module_GoogleAdsWP8_info; // GoogleAdsWP8.dll
	...
	extern gpointer*	mono_aot_module_WP8Native_info; // WP8Native.dll
	extern gpointer*	mono_aot_module_WP8PopUps_info; // WP8PopUps.dll
	extern gpointer*	mono_aot_module_mscorlib_info; // mscorlib.dll
#endif // !(TARGET_IPHONE_SIMULATOR)
	void	_GADCreateBannerAd();
	void	_GADCreateBannerAdPos();
	void	_GADShowAd();
	void	_GADHideAd();
	void	_GADRefresh();
	void	_GADSetPosition();
	void	_GADSetPositionXY();
	void	_initGoogleAd();
	void	_GADChangeBannersUnitID();
	void	_GADChangeInterstisialsUnitID();
	void	_GADAddKeyWord();
	void	_GADAddTestDevice();
	void	_GADAddTestDevices();
	void	_GADSetGender();
	void	_GADSetBirthday();
	void	_GADTagForChildDirectedTreatment();
	void	_GADDestroyBanner();
	void	_GADStartInterstitialAd();
	void	_GADLoadInterstitialAd();
	void	_GADShowInterstitialAd();
	void	_GADReportPurchaseStatus();
	void	_ISNsubscribe();
	void	_ISN_RedirectToAppStoreRatingPage();
	...
	void	_getLeadrBoardScore();
	void	_loadLeadrBoardScore();
	void	_showAchievements();
	void	_resetAchievements();
	void	_submitAchievement();
	void	_loadGCUserData();
	void	_ISN_issueLeaderboardChallenge();
	void	_ISN_issueLeaderboardChallengeWithFriendsPicker();
	void	_ISN_issueAchievementChallenge();
	void	_ISN_issueAchievementChallengeWithFriendsPicker();
	void	_gcRetrieveFriends();
	void	_findMatch();
	void	_sendDataToAll();
	void	_sendDataToPlayers();
	void	_disconnect();
	void	_loadStore();
	void	_restorePurchases();
	void	_buyProduct();
	void	_verifyLastPurchase();
	void	_createProductView();
	void	_showProductView();
	void	_ISN_ScheduleNotification();
	void	_ISN_ShowNotificationBanner();
	void	_ISN_CancelNotifications();
	void	_ISN_RequestNotificationPermitions();
	void	_ISN_CancelNotificationById();
	void	_ISN_ApplicationIconBadgeNumber();
	void	_ISN_SaveToCameraRoll();
	void	_ISN_GetImageFromCamera();
	void	_ISN_GetImageFromAlbum();
	void	_ISN_InitCamerAPI();
	void	_ISN_checkUrl();
	void	_ISN_openUrl();
	void	_ISN_SteamVideo();
	void	_ISN_OpenYoutubeVideo();
	void	_ISN_ShowRateUsPopUp();
	void	_ISN_ShowDialog();
	void	_ISN_ShowMessage();
	void	_ISN_DismissCurrentAlert();
	void	_ISN_TwPost();
	void	_ISN_TwPostWithMedia();
	void	_ISN_FbPost();
	void	_ISN_FbPostWithMedia();
	void	_ISN_MediaShare();
	void	_ISN_SendMail();
	void	_IADCreateBannerAd();
	void	_IADCreateBannerAdPos();
	void	_IADShowAd();
	void	_IADHideAd();
	void	_IADDestroyBanner();
	...
	void	_setDouble();
	void	_setData();
	void	_requestDataForKey();
	void	_MNP_ShowRateUsPopUp();
	void	_MNP_ShowDialog();
	void	_MNP_ShowMessage();
	void	_MNP_DismissCurrentAlert();
	void	_MNP_RedirectToAppStoreRatingPage();
...
void RegisterMonoModules()
{
	...
	mono_aot_register_module(mono_aot_module_GoogleAdsWP8_info);
	...
	mono_aot_register_module(mono_aot_module_WP8Native_info);
	mono_aot_register_module(mono_aot_module_WP8PopUps_info);
	mono_aot_register_module(mono_aot_module_mscorlib_info);

	mono_dl_register_symbol("_GADCreateBannerAd", (void*)&_GADCreateBannerAd);
	mono_dl_register_symbol("_GADCreateBannerAdPos", (void*)&_GADCreateBannerAdPos);
	mono_dl_register_symbol("_GADShowAd", (void*)&_GADShowAd);
	mono_dl_register_symbol("_GADHideAd", (void*)&_GADHideAd);
	mono_dl_register_symbol("_GADRefresh", (void*)&_GADRefresh);
	mono_dl_register_symbol("_GADSetPosition", (void*)&_GADSetPosition);
	mono_dl_register_symbol("_GADSetPositionXY", (void*)&_GADSetPositionXY);
	mono_dl_register_symbol("_initGoogleAd", (void*)&_initGoogleAd);
	mono_dl_register_symbol("_GADChangeBannersUnitID", (void*)&_GADChangeBannersUnitID);
	mono_dl_register_symbol("_GADChangeInterstisialsUnitID", (void*)&_GADChangeInterstisialsUnitID);
	mono_dl_register_symbol("_GADAddKeyWord", (void*)&_GADAddKeyWord);
	mono_dl_register_symbol("_GADAddTestDevice", (void*)&_GADAddTestDevice);
	mono_dl_register_symbol("_GADAddTestDevices", (void*)&_GADAddTestDevices);
	mono_dl_register_symbol("_GADSetGender", (void*)&_GADSetGender);
	mono_dl_register_symbol("_GADSetBirthday", (void*)&_GADSetBirthday);
	mono_dl_register_symbol("_GADTagForChildDirectedTreatment", (void*)&_GADTagForChildDirectedTreatment);
	mono_dl_register_symbol("_GADDestroyBanner", (void*)&_GADDestroyBanner);
	mono_dl_register_symbol("_GADStartInterstitialAd", (void*)&_GADStartInterstitialAd);
	mono_dl_register_symbol("_GADLoadInterstitialAd", (void*)&_GADLoadInterstitialAd);
	mono_dl_register_symbol("_GADShowInterstitialAd", (void*)&_GADShowInterstitialAd);
	mono_dl_register_symbol("_GADReportPurchaseStatus", (void*)&_GADReportPurchaseStatus);
	mono_dl_register_symbol("_ISNsubscribe", (void*)&_ISNsubscribe);
	mono_dl_register_symbol("_ISN_RedirectToAppStoreRatingPage", (void*)&_ISN_RedirectToAppStoreRatingPage);
	mono_dl_register_symbol("_ISN_ShowPreloader", (void*)&_ISN_ShowPreloader);
	mono_dl_register_symbol("_ISN_HidePreloader", (void*)&_ISN_HidePreloader);
	mono_dl_register_symbol("_initGamaCenter", (void*)&_initGamaCenter);
	mono_dl_register_symbol("_showLeaderBoard", (void*)&_showLeaderBoard);
	mono_dl_register_symbol("_reportScore", (void*)&_reportScore);
	mono_dl_register_symbol("_showLeaderBoards", (void*)&_showLeaderBoards);
	mono_dl_register_symbol("_getLeadrBoardScore", (void*)&_getLeadrBoardScore);
	mono_dl_register_symbol("_loadLeadrBoardScore", (void*)&_loadLeadrBoardScore);
	mono_dl_register_symbol("_showAchievements", (void*)&_showAchievements);
	mono_dl_register_symbol("_resetAchievements", (void*)&_resetAchievements);
	mono_dl_register_symbol("_submitAchievement", (void*)&_submitAchievement);
	mono_dl_register_symbol("_loadGCUserData", (void*)&_loadGCUserData);
	mono_dl_register_symbol("_ISN_issueLeaderboardChallenge", (void*)&_ISN_issueLeaderboardChallenge);
	mono_dl_register_symbol("_ISN_issueLeaderboardChallengeWithFriendsPicker", (void*)&_ISN_issueLeaderboardChallengeWithFriendsPicker);
	mono_dl_register_symbol("_ISN_issueAchievementChallenge", (void*)&_ISN_issueAchievementChallenge);
	mono_dl_register_symbol("_ISN_issueAchievementChallengeWithFriendsPicker", (void*)&_ISN_issueAchievementChallengeWithFriendsPicker);
	mono_dl_register_symbol("_gcRetrieveFriends", (void*)&_gcRetrieveFriends);
	mono_dl_register_symbol("_findMatch", (void*)&_findMatch);
	mono_dl_register_symbol("_sendDataToAll", (void*)&_sendDataToAll);
	mono_dl_register_symbol("_sendDataToPlayers", (void*)&_sendDataToPlayers);
	mono_dl_register_symbol("_disconnect", (void*)&_disconnect);
	mono_dl_register_symbol("_loadStore", (void*)&_loadStore);
	mono_dl_register_symbol("_restorePurchases", (void*)&_restorePurchases);
	mono_dl_register_symbol("_buyProduct", (void*)&_buyProduct);
	mono_dl_register_symbol("_verifyLastPurchase", (void*)&_verifyLastPurchase);
	mono_dl_register_symbol("_createProductView", (void*)&_createProductView);
	mono_dl_register_symbol("_showProductView", (void*)&_showProductView);
	mono_dl_register_symbol("_ISN_ScheduleNotification", (void*)&_ISN_ScheduleNotification);
	mono_dl_register_symbol("_ISN_ShowNotificationBanner", (void*)&_ISN_ShowNotificationBanner);
	mono_dl_register_symbol("_ISN_CancelNotifications", (void*)&_ISN_CancelNotifications);
	mono_dl_register_symbol("_ISN_RequestNotificationPermitions", (void*)&_ISN_RequestNotificationPermitions);
	mono_dl_register_symbol("_ISN_CancelNotificationById", (void*)&_ISN_CancelNotificationById);
	mono_dl_register_symbol("_ISN_ApplicationIconBadgeNumber", (void*)&_ISN_ApplicationIconBadgeNumber);
	mono_dl_register_symbol("_ISN_SaveToCameraRoll", (void*)&_ISN_SaveToCameraRoll);
	mono_dl_register_symbol("_ISN_GetImageFromCamera", (void*)&_ISN_GetImageFromCamera);
	mono_dl_register_symbol("_ISN_GetImageFromAlbum", (void*)&_ISN_GetImageFromAlbum);
	mono_dl_register_symbol("_ISN_InitCamerAPI", (void*)&_ISN_InitCamerAPI);
	mono_dl_register_symbol("_ISN_checkUrl", (void*)&_ISN_checkUrl);
	mono_dl_register_symbol("_ISN_openUrl", (void*)&_ISN_openUrl);
	mono_dl_register_symbol("_ISN_SteamVideo", (void*)&_ISN_SteamVideo);
	mono_dl_register_symbol("_ISN_OpenYoutubeVideo", (void*)&_ISN_OpenYoutubeVideo);
	mono_dl_register_symbol("_ISN_ShowRateUsPopUp", (void*)&_ISN_ShowRateUsPopUp);
	mono_dl_register_symbol("_ISN_ShowDialog", (void*)&_ISN_ShowDialog);
	mono_dl_register_symbol("_ISN_ShowMessage", (void*)&_ISN_ShowMessage);
	mono_dl_register_symbol("_ISN_DismissCurrentAlert", (void*)&_ISN_DismissCurrentAlert);
	mono_dl_register_symbol("_ISN_TwPost", (void*)&_ISN_TwPost);
	mono_dl_register_symbol("_ISN_TwPostWithMedia", (void*)&_ISN_TwPostWithMedia);
	mono_dl_register_symbol("_ISN_FbPost", (void*)&_ISN_FbPost);
	mono_dl_register_symbol("_ISN_FbPostWithMedia", (void*)&_ISN_FbPostWithMedia);
	mono_dl_register_symbol("_ISN_MediaShare", (void*)&_ISN_MediaShare);
	mono_dl_register_symbol("_ISN_SendMail", (void*)&_ISN_SendMail);
	mono_dl_register_symbol("_IADCreateBannerAd", (void*)&_IADCreateBannerAd);
	mono_dl_register_symbol("_IADCreateBannerAdPos", (void*)&_IADCreateBannerAdPos);
	mono_dl_register_symbol("_IADShowAd", (void*)&_IADShowAd);
	mono_dl_register_symbol("_IADHideAd", (void*)&_IADHideAd);
	mono_dl_register_symbol("_IADDestroyBanner", (void*)&_IADDestroyBanner);
	mono_dl_register_symbol("_IADStartInterstitialAd", (void*)&_IADStartInterstitialAd);
	mono_dl_register_symbol("_IADLoadInterstitialAd", (void*)&_IADLoadInterstitialAd);
	mono_dl_register_symbol("_IADShowInterstitialAd", (void*)&_IADShowInterstitialAd);
	mono_dl_register_symbol("_initCloud", (void*)&_initCloud);
	mono_dl_register_symbol("_setString", (void*)&_setString);
	mono_dl_register_symbol("_setDouble", (void*)&_setDouble);
	mono_dl_register_symbol("_setData", (void*)&_setData);
	mono_dl_register_symbol("_requestDataForKey", (void*)&_requestDataForKey);
	mono_dl_register_symbol("_MNP_ShowRateUsPopUp", (void*)&_MNP_ShowRateUsPopUp);
	mono_dl_register_symbol("_MNP_ShowDialog", (void*)&_MNP_ShowDialog);
	mono_dl_register_symbol("_MNP_ShowMessage", (void*)&_MNP_ShowMessage);
	mono_dl_register_symbol("_MNP_DismissCurrentAlert", (void*)&_MNP_DismissCurrentAlert);
	mono_dl_register_symbol("_MNP_RedirectToAppStoreRatingPage", (void*)&_MNP_RedirectToAppStoreRatingPage);
	mono_dl_register_symbol("_MNP_ShowPreloader", (void*)&_MNP_ShowPreloader);
	mono_dl_register_symbol("_MNP_HidePreloader", (void*)&_MNP_HidePreloader);
...
void RegisterAllStrippedInternalCalls ()
{
	...
	void Register_UnityEngine_CanvasRenderer_SetVertices ();
	Register_UnityEngine_CanvasRenderer_SetVertices ();
	...
	void Register_UnityEngine_CanvasRenderer_get_hideIfInvisible ();
	Register_UnityEngine_CanvasRenderer_get_hideIfInvisible ();
	void Register_UnityEngine_CanvasRenderer_set_hideIfInvisible ();
	Register_UnityEngine_CanvasRenderer_set_hideIfInvisible ();
